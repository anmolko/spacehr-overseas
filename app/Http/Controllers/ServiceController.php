...
class ServiceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if(!empty($request->file('banner_image'))){
            ...
            $thumb_moved    = Image::make($image->getRealPath())->fit(410, 285)->orientate()->save($thumb.$thumb_name);
    ...
    public function update(Request $request, $id)
    {
        ...
        if (!empty($request->file('banner_image'))){
            ...
            $thumb_moved  = Image::make($image->getRealPath())->fit(410, 285)->orientate()->save($thumb_path.$thumb_name);
